...
class LoteSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        """
        Al crear un lote, propagar cantidad_contrato_global a otros lotes
        del mismo producto+contrato si se proporciona un valor.
        """
    ...
    def update(self, instance, validated_data):
        ...
        # Auto-propagar cantidad_contrato_global al editar
        ccg = instance.cantidad_contrato_global
        if ccg is not None and instance.numero_contrato and instance.producto:
            Lote.objects.filter(
                producto=instance.producto,
