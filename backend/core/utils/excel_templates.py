...
def generar_plantilla_productos():
    ...
    instrucciones = [
        ...
        [""],
        ["CLAVE*:", "Código único del producto (3-50 caracteres). Ej: PAR-500, IBU-400"],
        ["NOMBRE*:", "Nombre completo del producto (mínimo 5 caracteres)"],
        ["DESCRIPCIÓN:", "Descripción detallada (opcional)"],
        ["UNIDAD MEDIDA*:", "Valores permitidos: pieza, caja, frasco, sobre, ampolleta, tableta, capsula, ml, gr"],
        ["CATEGORÍA*:", "Valores: medicamento, material_curacion, insumo"],
        ["SUSTANCIA ACTIVA:", "Principio activo del medicamento (opcional)"],
        ["PRESENTACIÓN:", "Formato de presentación (opcional)"],
        ["CONCENTRACIÓN:", "Dosis o concentración (opcional)"],
        ["VÍA ADMINISTRACIÓN:", "Ruta de administración (opcional)"],
        ["STOCK MÍNIMO*:", "Cantidad mínima en inventario (número entero)"],
        ["REQUIERE RECETA:", "Si/No - Indica si requiere receta médica"],
        ["ES CONTROLADO:", "Si/No - Indica si es medicamento controlado"],
        ["ACTIVO:", "Si/No - Estado del producto (default: Si)"],
        [""],
        ["NOTAS IMPORTANTES:"],
        ["• La clave debe ser única en todo el sistema"],
        ["• Los valores booleanos aceptan: Si/Sí/Yes/True/1 para verdadero"],
        ["• No incluir el símbolo * en los datos, solo indica que es obligatorio"],
