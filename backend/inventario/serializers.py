...
class RequisicionSerializer(serializers.ModelSerializer):
    ...
    solicitante_nombre = serializers.CharField(source='usuario_solicita.get_full_name', read_only=True)
    solicitante_username = serializers.CharField(source='usuario_solicita.username', read_only=True)
