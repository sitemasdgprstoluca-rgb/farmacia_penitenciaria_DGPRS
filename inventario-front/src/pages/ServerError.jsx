    ...
    >
      <div className="max-w-md w-full text-center">
        <div className="mb-8">
          ...
          <h2 className="text-2xl font-semibold text-gray-700 mb-2">Error del servidor</h2>
        ...
        <div className="space-y-3">
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-gray-600 text-white rounded-lg font-semibold transition-all transform hover:scale-105 hover:shadow-lg hover:bg-gray-700 mr-3"
          >
            <FaRedo />
            Reintentar
          </button>
